...
# claude/settled-after-turn, which pins the "· done <clock>" end-of-turn
# clause Claude Code introduced at 2.1.247 — the recording itself is at
# 2.1.270) is rebaked on demand via `make rebake-corpus`, not in the
