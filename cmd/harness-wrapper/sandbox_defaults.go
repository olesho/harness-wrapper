...
// skipPermissionsFlag is the claude-code arg --sandbox-defaults injects.
...
func applySandboxDefaults(harnessName string, args, env []string) ([]string, []string) {
	if harnessName != "claude" {
		return args, env
	}
	if !hasSkipPermissionsFlag(args) {
