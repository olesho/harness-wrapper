...
> Both files carry claude-code `2.1.265` as of 2026-09-08, verified live against the installed
> 2.1.265 binary via `TestRunTurn_RealClaudeDogfood{,KeepAlive}` (end-of-turn detection, reply
...
> drift by design, and the no-args mode would drag this repo's pin *backwards* by 47 releases.
